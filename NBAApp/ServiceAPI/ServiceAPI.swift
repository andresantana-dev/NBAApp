...
class ServiceAPI {
    ...
    private let apiKey = ""
    private let apiURL = "https://fly.sportsdata.io/v3/nba/scores/json/GamesByDate/"
    private var dataTask: URLSessionDataTask?
    
    // MARK: - Methods
    
    func getGames(date: String, completion: @escaping(Result<[Game], ServiceError>) -> Void) {
        guard let url = URL(string: "\(apiURL)\(date)?key=e6496d3bff164fa6b02ff24019d72f93") else {
